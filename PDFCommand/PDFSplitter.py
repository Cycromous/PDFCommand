...
class SplitterFrame(tk.Frame):
    ...
    def setup_gui(self):
        ...
        tk.Button(inner, text="⬅ Home", command=self.go_home, bg=TOOLBAR_COLOR, fg=TEXT_COLOR,
                  font=("Segoe UI", 10, "bold"), bd=0, cursor="hand2").pack(side=tk.LEFT, padx=(0, 15))
        ...
        self.btn_load = create_rounded_button(inner, "📂 Load PDF", "#FFFFFF", "#374151",
        ...
        self.btn_split = create_rounded_button(inner, "✂ Split & Save", "#111827", "#FFFFFF",
        ...
        self.info_label = tk.Label(self.work_area, text="No PDF Loaded", font=("Segoe UI", 16, "bold"),
        ...
        self.range_frame = tk.Frame(self.work_area, bg="#FFFFFF", padx=30, pady=30,
                                     highlightthickness=1, highlightbackground="#D1D5DB")

        tk.Label(self.range_frame, text="Enter Page Range (e.g. 1-3, 5, 8-10):", bg="#FFFFFF",
    ...
    def split_pdf(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Invalid range format.\n\n{e}"
